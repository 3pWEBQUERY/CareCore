...
type ResidentRow = { id: string; first_name: string; last_name: string; room: string; care_unit: string };

const NO_CONTEXT = "Ohne Bewohnerbezug";
const UNASSIGNED = "Nicht zugewiesen · Team";
const PRIORITY_ORDER: TaskPriority[] = ["normal", "high", "critical", "low"];

const zurichParts = (value: string) => {
