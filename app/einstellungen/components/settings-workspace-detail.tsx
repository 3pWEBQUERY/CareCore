...
type DetailSpec = { description: string; label: string; kind: "toggle" | "select" | "action" | "notifications"; value?: string; options?: string[]; action?: string; notificationItems?: NotificationRow[] };
...
const detailById: Record<string, DetailSpec> = {
  ...
  notifications: { description: "Wähle, welche Hinweise dich während deiner Dienste erreichen.", label: "Benachrichtigungen im Dienst aktiv", kind: "notifications", notificationItems: [
    { icon: "alert", title: "Kritische Hinweise", description: "Sturz, Medikationsabweichung und Eskalation", value: "Sofort" },
    { icon: "tasks", title: "Aufgaben & Fälligkeiten", description: "Erinnerung vor und bei Überfälligkeit", value: "30 Min vorher" },
    { icon: "handover", title: "Übergaben", description: "Neue Hinweise seit deinem letzten Dienst", value: "Dienststart" },
    { icon: "wounds", title: "Wundversorgung", description: "Änderungen an deinen betreuten Wundfällen", value: "Bei Änderung" },
    { icon: "vitals", title: "Vitalwerte", description: "Messwerte ausserhalb definierter Grenzwerte", value: "Bei Grenzwert" },
    { icon: "team", title: "Team & Nachrichten", description: "Neue Direktnachrichten und Erwähnungen", value: "Sofort" },
    { icon: "docs", title: "Systemhinweise", description: "Wartungen, Standards und wichtige Updates", value: "Täglich · 08:00" },
  ] },
