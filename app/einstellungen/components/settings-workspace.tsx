...
const cards: Record<SettingsView, { title: string; description: string; eyebrow: string; items: SettingCard[] }> = {
  overview: {
    ...
    title: "Einstellungen",
    description: "Dein persönlicher Arbeitsbereich für Profil, Benachrichtigungen und Sicherheit.",
    items: [
      {
        id: "profile",
        title: "Profil & Präferenzen",
        description: "Name, Rolle und persönliche Arbeitszeiten",
        value: "Anna Meier",
        icon: "team",
      },
      {
        ...
        description: "Eskalationen, Aufgaben und Übergaben",
        value: "7 aktiv",
        icon: "bell",
      },
      {
        ...
        description: "Passwort, Sitzungen und Zwei-Faktor-Schutz",
        value: "Geschützt",
        icon: "quality",
      },
      {
        id: "appearance",
        title: "Darstellung",
        description: "Dichte, Kontrast und Startseite",
        value: "Standard",
        icon: "pulse",
      },
    ],
  ...
  profile: {
    ...
    title: "Profil & Präferenzen",
    description: "Passe deine persönlichen CareCore-Einstellungen an.",
    items: [
      {
        id: "profile-name",
        title: "Anna Meier",
        description: "Pflegefachfrau HF · Wohnbereich 2",
        value: "Aktiv",
        icon: "team",
      },
      {
        id: "profile-shift",
        title: "Arbeitszeiten",
        description: "Frühdienst 07:00–15:30 · Zeitzone Europe/Zurich",
        value: "Gespeichert",
        icon: "calendar",
      },
    ],
  ...
  notifications: {
    ...
    title: "Benachrichtigungen",
    description: "Lege fest, wann CareCore dich aktiv informiert.",
    items: [
      {
        id: "notify-critical",
        title: "Kritische Hinweise",
        description: "Sofort bei Sturz, Medikationsabweichung und Eskalation",
        value: "Aktiv",
        icon: "alert",
      },
      {
        ...
        description: "30 Minuten vor der Fälligkeit und bei Überfälligkeit",
        value: "Aktiv",
        icon: "tasks",
      },
      {
  ...
  security: {
    ...
    title: "Sicherheit & Zugriff",
    description: "Kontrolliere deine aktiven Sitzungen und Schutzmechanismen.",
    items: [
      {
        id: "sec-password",
        title: "Passwort",
        description: "Zuletzt geändert vor 42 Tagen",
        value: "Ändern",
        icon: "quality",
      },
      {
        ...
        description: "Zusätzlicher Schutz bei der Anmeldung",
        value: "Aktiv",
        icon: "check",
      },
      {
        ...
        description: "1 Sitzung auf diesem Gerät",
        value: "Prüfen",
        icon: "pulse",
      },
    ],
  ...
  appearance: {
    ...
    title: "Darstellung",
    description: "Optimiere CareCore für deinen persönlichen Arbeitsfluss.",
    items: [
      {
        id: "app-density",
        title: "Informationsdichte",
        description: "Kompakte Zeilen für grosse Arbeitslisten",
        value: "Standard",
        icon: "chart",
      },
      {
        id: "app-contrast",
        title: "Kontrast",
        description: "Hoher Kontrast für klare Statusfarben",
        value: "Standard",
        icon: "quality",
      },
      {
        id: "app-start",
        title: "Startseite",
        description: "Persönlicher Schichtarbeitsplatz beim Öffnen",
        value: "Mein Dienst",
        icon: "home",
      },
    ],
            ...
            <aside className="card settings-nav">
              ...
              <nav aria-label="Einstellungsnavigation">
                {(
                  ...
                  ] as Array<[SettingsView, string, ModuleIconName]>
                ).map(([id, label, icon]) => (
                  <button
              ...
              <section className="card settings-detail">
                ...
                <div className="settings-detail-body">
                  ...
                  <label className="settings-toggle">
                    <span>Für meinen Arbeitsbereich aktiv</span>
                    <input type="checkbox" defaultChecked aria-label={`${selected.title} aktiv`} />
                    <i />
                  </label>
                </div>
                <div className="settings-detail-footer">
                  <button
                    ...
                    type="button"
                    onClick={() => showToast(`${selected.title} geöffnet`)}
                  >
                    Details öffnen
                  </button>
                </div>
