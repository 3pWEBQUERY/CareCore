...
const emptyBiography: ResidentBiography = {
  lifeStory: "",
  importantPeople: "",
  dailyRoutines: "",
  preferences: "",
  ...
  return (
    <div className="resident-record-layer">
                  ...
                  <div className="body-observation-list" aria-label="Erfasste Körperstellen">
                    ...
                    {!bodyLoading && bodyObservations.length === 0 && (
                      <div className="body-observation-empty">
                        ...
                        <p>
                          Wunden, Rötungen und weitere Auffälligkeiten können direkt am Körpermodell markiert werden.
                        </p>
                      ...
                      return (
                        <section className={`body-observation ${expanded ? "expanded" : ""}`} key={observation.id}>
                          <button
                            ...
                            onClick={() =>
                              setActiveBodyObservationId((current) =>
            ...
            <div className="care-record-page-heading">
              ...
              <div className="care-record-heading-actions">
                <button
                  className="secondary-button"
                  type="button"
                  onClick={() => onAction("Neue Einschätzung vorbereitet")}
                >
                  Neue Einschätzung
                </button>
          ...
          <main className="resident-record-content biography-view" ref={contentRef} key="biography">
            ...
            <section className="biography-intro" aria-label="Hinweis zur Biografie">
              ...
              <div>
                ...
                <p>
                  Biografische Angaben werden nur für die Betreuung und Pflege verwendet. Ergänze nur Informationen, die
                  für den Alltag des Bewohners hilfreich sind.
                </p>
              </div>
              <small>
                {biography.updatedAt
                    ...
                    {biographyEditing ? (
                      <label className="biography-field">
                        ...
                        <textarea
                          ...
                          onChange={(event) =>
                            setBiography((current) => ({ ...current, strengths: event.target.value }))
                          }
                      ...
                      {biographyEditing ? (
                        <label className="biography-field">
                          ...
                          <textarea
                            ...
                            onChange={(event) =>
                              setBiography((current) => ({ ...current, preferences: event.target.value }))
                            }
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>
                    {
                      supplies.filter(
                        (item) => item.status === "active" && item.current_quantity < item.target_quantity,
                      ).length
                    }{" "}
                    Positionen
                  </strong>
          ...
          >
            ...
            >
              <div className="body-observation-editor-heading">
                <div>
                  <span className="record-section-label">
                    Körperstatus · {bodyEditor.id ? "Bearbeiten" : "Neuer Befund"}
                  </span>
              ...
              <div className="body-observation-editor-fields">
                <label>
                  ...
                  <CareSelect
                    ...
                    label="Art"
                    value={
                      { wound: "Wunde", redness: "Rötung", fracture: "Fraktur", other: "Sonstiges" }[
                        bodyEditor.draft.kind
                      ]
                    }
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      setBodyEditor(
                        (current) =>
                          current && { ...current, draft: { ...current.draft, location: event.target.value } },
                      )
                    }
      ...
      {contactEditor && (
        ...
        >
          <section
            className="contact-editor-panel"
            role="dialog"
            aria-modal="true"
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      setContactEditor((current) =>
                        current
                          ? { ...current, draft: { ...current.draft, relationship: event.target.value } }
                          : current,
                      )
                    }
                ...
                <label className={contactEditor.draft.isPrimary ? "active" : ""}>
                  <input
                    ...
                    onChange={(event) =>
                      setContactEditor((current) =>
                        current
                          ? { ...current, draft: { ...current.draft, isPrimary: event.target.checked } }
                          : current,
                      )
                    }
                  />
                  ...
                  <>
                    <label className="area-editor-wide">
                      ...
                      <CareSelect
                        label="Pflegeprodukt"
                        value={
                          careSupplyProducts.find((product) => product.id === supplyEditor.draft.productId)
                            ?.item_name ?? "Produkt wählen"
                        }
