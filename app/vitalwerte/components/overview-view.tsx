...
const FILTERS = ["Alle", "Kritisch", "Beobachten", "Im Zielbereich", "Ohne Messung"] as const;
...
function ClinicalNote({ resident }: { resident: VitalResident }) {
...
function MeasurementList({ measurements, unit }: { measurements: VitalMeasurement[]; unit: string }) {
